...
class PointCTDataset:
    ...
    def __init__(
        ...
        if declared_ready is not None and int(declared_ready) != len(self.records):
    ...
    def load_case_metadata(self, index: int) -> Dict:
        ...
        gt_transform = _resolve_gt_transform(pair_metadata)
        return {
